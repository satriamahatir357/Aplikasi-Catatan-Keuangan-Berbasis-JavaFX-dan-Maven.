...
public class TransaksiService {
    ...
    public ObservableList<Transaksi> getDatarTransakasi(){ // getDatarTransakasi() adalah sebuah metode yang digunakan untuk mengambil data transaksi yang disimpan dalam daftarTransaksi.
    ...
    public double getTotalPemasukkan(){
        ...
        for(Transaksi transaksi : daftarTransaksi){  // Melakukan iterasi (perulangan) untuk setiap transaksi dalam daftarTransaksi
            if(transaksi.getTipe().equals("Pemasukkan")){ // Memeriksa apakah tipe transaksi adalah "Pemasukkan" dengan menggunakan metode get
    ...
    public double getSaldo(){
        return getTotalPemasukkan() - totalPengeluaran(); // Menghitung saldo dengan mengurangi total pengeluaran dari total pemasukan menggunakan metode getTotalPemasukkan() dan totalPengeluaran().
    }
}
